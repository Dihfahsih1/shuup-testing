...
time.sleep(1)
browser.find_element(By.XPATH,"//*[@id='picotable']/div/table/tbody/tr[3]/td[1]/div/a/i").click()
browser.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/div/div/form/div/a").click()
browser.find_element(By.XPATH,"//*[@id='id_base-first_name']").send_keys('Ron')
