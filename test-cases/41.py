...
name = browser.find_element(By.ID,"id_cookie_categories-0-name__en")
name.send_keys("cookie")
time.sleep(1)

name = browser.find_element(By.ID,"id_cookie_categories-0-how_is_used__en")
name.send_keys("cook")
time.sleep(1)

name = browser.find_element(By.ID,"id_cookie_categories-0-cookies")
name.send_keys("cook")
time.sleep(1)
