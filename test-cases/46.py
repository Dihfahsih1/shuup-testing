...
name = browser.find_element(By.ID,"id_base-name__en")
name.send_keys("Dell Laptop 2")
time.sleep(1)

short = browser.find_element(By.XPATH,"//*[@id='id_base-short_description__en']")
short.send_keys("Dell Inspiron i5 Personal Laptop")
time.sleep(1)

description = browser.find_element(By.XPATH,"//*[@id='id_base-description__en-editor-wrap']/div[2]/div[3]/div[2]")
...
price = browser.find_element(By.XPATH,"//*[@id='id_shop1-default_price_value']")
