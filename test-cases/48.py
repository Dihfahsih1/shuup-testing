...
browser.find_element(By.ID,"id_base-name__en").send_keys("Beard Oil")
time.sleep(1)

save_attempt = browser.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/div/div/form/div/div[1]/button[1]")
save_attempt.click()
